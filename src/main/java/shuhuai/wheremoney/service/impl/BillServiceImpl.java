...
public class BillServiceImpl implements BillService {
    ...
    @Override
    public void addBill(Integer bookId, Integer inAssetId, Integer outAssetId, Integer billCategoryId, BillType type, BigDecimal amount, Date time, String remark) {
